...
PORTFOLIO_COURSE_DELIVERABLES = [
    {
        ...
        "icon": "layers",
        "image": "deliverable-accessibility-resources.webp",
    ...
    {
        "course": "AIL 605a",
        "title": "Two-Dimensional Geometrical Shapes Interactive Module",
        "format": "Articulate Rise 360 course",
        "icon": "layers",
        "image": "deliverable-storyboard.png",
        "body": "A fully self-paced interactive lesson built in Articulate Rise 360: branching navigation, audio narration, embedded video, knowledge checks, and responsive layout aligned with WCAG accessibility guidance. Storyboarded end to end before development so narrative pacing and learner-choice moments were fixed by design rather than discovered in the authoring tool.",
        "evidence": "Shipped evidence of the full development cycle — storyboard through polished, accessible, learner-facing product.",
        "skills": ["Articulate Rise 360", "Interactive eLearning", "Branching Navigation", "WCAG Accessibility"],
        "url": "https://360.articulate.com/review/content/d5649f65-923e-4144-906c-409b7eb97ddd/review",
    },
    {
        "course": "AIL-605",
        ...
        "icon": "file-text",
        "image": "deliverable-multimedia-proposal.webp",
    ...
    <div class="two-column">
      <div>
        ...
        <figure class="research-portrait fade">
          <img src="assets/images/research-portrait-office.png" alt="David Awoyemi at his desk, with screens showing a Learning Analytics Dashboard and AI in Education research" loading="lazy" decoding="async">
        </figure>
      </div>
      <div>
        <div class="section-heading">
    ...
    for index, item in enumerate(PORTFOLIO_COURSES):
        ...
        course_panels.append(
            ...
            <div class="course-panel{active_class}" data-course-panel="{escape(item['code'])}">
              <article class="course-detail-card course-detail-card--with-image{' course-detail-card--with-image-wide' if item.get('detail_image') else ''} fade">
                <figure class="course-detail-thumb">
                  <img src="assets/images/courses/{item.get('detail_image', item['image'])}" alt="{escape(item.get('detail_image_alt', item['image_alt']))}" loading="lazy" decoding="async">
                </figure>
...
<main id="main-content" class="main-wrap">
  ...
  <section class="section">
    <div class="section-inner">
      <div class="section-heading">
        <span class="eyebrow">Featured Project</span>
        <h2>Canvas Course Prototype: The Principles of Instructional Design.</h2>
        <p>Designed a full prototype online course in the Canvas LMS with clear learning outcomes, modular content, varied assessments, and multimedia — paired with a narrated walkthrough explaining the design rationale. Applied ADDIE, UDL, backward design, and multimedia learning principles, with deliberate attention to learner decision points.</p>
      </div>
      <a href="https://portfolios.davidawoyemi.net/ail-604/" class="featured-preview-card fade" target="_blank" rel="noreferrer">
        <div class="fpc-header">
          <span class="feh-badge">Canvas LMS</span>
          <span class="feh-badge feh-badge-alt">View Reflection</span>
        </div>
        ...
        <div class="fpc-footer">
          ...
          <div class="fpc-sub">AIL-604 · Distance Learning Technologies · Opens in new tab</div>
        </div>
      </a>
      <div class="hero-actions" style="margin-top: 1.2rem;">
        <a class="button" href="https://drive.google.com/file/d/1ONmk6bU7Pws5tdXsuwHx244y9V1aQLId/view?usp=sharing" target="_blank" rel="noreferrer">View Artifact</a>
        <a class="button-secondary" href="https://portfolios.davidawoyemi.net/ail-604/" target="_blank" rel="noreferrer">Read Reflection</a>
      </div>
      <div class="portfolio-skill-tags"><span>Canvas LMS</span><span>ADDIE</span><span>Universal Design for Learning</span><span>Backward Design</span><span>Multimedia Learning</span></div>
    </div>
  </section>
  ...
  <section class="section-alt">
    <div class="section-inner">
      <div class="section-heading">
        ...
        <h2>Activating Annotation in Blackboard — faculty PD prototype.</h2>
      ...
      <div class="cit-training-grid fade">
        <figure class="cit-training-tile cit-training-tile--hero">
          <img src="assets/images/cit-training/cit-slide-01.png" alt="Creating Effective Instructional Technology Documentation and Training, July 2024, David Awoyemi" loading="lazy" decoding="async">
          <figcaption>Creating Effective Instructional Technology Documentation and Training.</figcaption>
        </figure>
        ...
        <figure class="cit-training-tile">
          <img src="assets/images/cit-training/cit-slide-07.png" alt="Getting Started with Hypothesis — Hypothesis in Teaching and Learning" loading="lazy" decoding="async">
          <figcaption>Getting started with Hypothesis in teaching and learning.</figcaption>
        </figure>
        <figure class="cit-training-tile">
